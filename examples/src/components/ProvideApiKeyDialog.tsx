    ...
    return () => (
      <div class="provide-api-key-dialog text-left">
        <div class="absolute top-0 bg-neutral-900 flex justify-center items-center text-sm font-medium text-neutral-100 h-10 w-full gap-x-2 left-0">
          ...
          <span class="mx-0 px-0 underline text-neutral-100 cursor-pointer" onClick={() => setShowDialog(true)}>
            Change
          </span>
          <el-dialog
            v-model={showDialog.value}
            title="Provide Copilot Cloud Public API key"
            show-close={false}
          ...
          >
            ...
            <div class="flex">
              ...
              <el-button class="ml-2 w-80px" type="primary" onClick={handleSubmit}>
                修改
              </el-button>
              <el-button class="ml-2 w-80px" type="primary" onClick={handleCancel}>
                取消
              </el-button>
            </div>
          </el-dialog>
